...
protected:
    ...
    void dropEvent( QDropEvent *e)
    {
        ...
        if(e->mimeData()->text()=="kasa_06.png"){
            QGraphicsPixmapItem *kasa_06 = scene()->addPixmap(QPixmap( ":pictgrams/picts/kasa_06.png"));//シーンに画像を配置
            ...
            QGraphicsPixmapItem *kasa_h_03 = scene()->addPixmap(QPixmap( ":pictgrams/picts/kasa_h_03.png" ));
            ...
            QGraphicsPixmapItem *kasa_m_07 = scene()->addPixmap(QPixmap( ":pictgrams/picts/kasa_m_07.png"));
            ...
            QGraphicsPixmapItem *kasa_migi_03 = scene()->addPixmap(QPixmap( ":pictgrams/picts/kasa_migi_03.png" ));
            ...
            QGraphicsPixmapItem *kasa_y_03 = scene()->addPixmap(QPixmap( ":pictgrams/picts/kasa_y_03.png" ));
